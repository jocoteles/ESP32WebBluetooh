...
// NOVO: Callback para quando uma variável é alterada pelo cliente
...
public:
  ...
  // NOVO: Define a função a ser chamada quando uma variável muda
...
private:
  ...
  VariableChangeCallback onVariableChange = nullptr; // NOVO: Pointer para o callback
